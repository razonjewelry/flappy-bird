...
const SHAPES = {
  ...
  more: (c) => (
    <>
      <Path d="M12 6.4a1.6 1.6 0 1 0 0-3.2 1.6 1.6 0 0 0 0 3.2z" fill={c} />
      <Path d="M12 13.6a1.6 1.6 0 1 0 0-3.2 1.6 1.6 0 0 0 0 3.2z" fill={c} />
      <Path d="M12 20.8a1.6 1.6 0 1 0 0-3.2 1.6 1.6 0 0 0 0 3.2z" fill={c} />
    </>
  ),
  cloud: (c, w) => (
    <Path
