/* Generates the app icons (teal background + white flower) as PNGs,
   using only Node's built-in zlib — no native image libraries needed.
...
makePNG(1024, 1.0, false, 'icon.png');            // app icon (full teal)
